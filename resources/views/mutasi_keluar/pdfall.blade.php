		...
		<body>
			...
			<table class="tg">
			  <tr>
			    ...
			    <th class="tg-3wr7">Pengirim<br></th>
			 ...
			 @foreach($mutasi_keluar as $data)
			  <tr>
			    ...
			    <td class="tg-rv4w" width="10%">{{$data->pengirim}}</td>
			    <td class="tg-rv4w" width="20%">{{$data->penerima}}</td>
			    <td class="tg-rv4w" width="10%">{{$data->barang->nm_barang}}</td>
			    <td class="tg-rv4w" width="20%">{{$data->jumlah_barang}}</td>
			  </tr>
			  @endforeach
			</table>
		</body>
