			...
			<table class="tg">
			 ...
			 @foreach($supp as $data)
			  <tr>
			    ...
			    <td class="tg-rv4w" width="20%">{{$data->kode_supplier}}</td>
			    <td class="tg-rv4w" width="10%">{{$data->nm_supplier}}</td>
			    <td class="tg-rv4w" width="20%">{{$data->alamat}}</td>
			    <td class="tg-rv4w" width="20%">{{$data->telepon}}</td>
			  </tr>
			  @endforeach
			</table>
		</body>
